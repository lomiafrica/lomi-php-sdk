...
| ------------- | ------------- | ------------- |
| [**listInstallmentPayments()**](BNPLApi.md#listInstallmentPayments) | **GET** /installment_payments | List installment payments |
| [**retrieveInstallmentPayment()**](BNPLApi.md#retrieveInstallmentPayment) | **GET** /installment_payments/{payment_id} | Retrieve installment payment |
...
try {
    ...
    echo 'Exception when calling BNPLApi->retrieveInstallmentPayment: ', $e->getMessage(), PHP_EOL;
}
```
