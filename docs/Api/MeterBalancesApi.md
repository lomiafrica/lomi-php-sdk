...
$apiInstance = new LomiSDK\Api\MeterBalancesApi(
...
try {
    ...
    echo 'Exception when calling MeterBalancesApi->listMeterBalances: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling MeterBalancesApi->retrieveMeterBalance: ', $e->getMessage(), PHP_EOL;
}
```
