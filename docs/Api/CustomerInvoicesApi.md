...
$apiInstance = new LomiSDK\Api\CustomerInvoicesApi(
...
try {
    ...
    echo 'Exception when calling CustomerInvoicesApi->listCustomerInvoices: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CustomerInvoicesApi->retrieveCustomerInvoice: ', $e->getMessage(), PHP_EOL;
}
```
